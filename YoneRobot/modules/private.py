    ...
    client.send_message(message.chat.id,
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "🌹 Channel", url=f"https://t.me/spyfams"), 
                    InlineKeyboardButton(
                        "🍂 Group", url=f"https://t.me/seconpi")
                ],[
                    InlineKeyboardButton(
                        "✨ OWNER ✨", url=f"https://t.me/alipunyalia")
                ]
            ]
        ),
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "🍂 GROUP", url=f"https://t.me/spyfams"
                    )
                ]
            ]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '🔯 Channel', url=f"https://t.me/seconpi"),
             InlineKeyboardButton(text = '🍂 Group', url=f"https://t.me/spyfams")],
            [InlineKeyboardButton(text = '✨ OWNER ✨', url=f"https://t.me/alipunyalia")],
